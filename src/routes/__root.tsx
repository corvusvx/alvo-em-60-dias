...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Seja aprovado no concurso dos seus sonhos com o Paiva. Policial militar, aprovado aos 17, hoje ajuda milhares de candidatos com direção e material de qualidade." },
      { name: "author", content: "Paiva — Alvo Policial" },
      { property: "og:title", content: "Alvo Policial — Seja aprovado com o Paiva" },
      { property: "og:description", content: "Concurso público exige direção e material de qualidade. O Paiva entrega os dois — cursos, simulados e mentoria no WhatsApp." },
