...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mentoria individual e cursos com Matheus Paiva para concursos públicos. Planos para PM e hub em expansão. Suporte direto no WhatsApp." },
      { name: "author", content: "Paiva — Alvo Policial" },
      { property: "og:title", content: "Alvo Policial — Mentoria para Concursos Públicos" },
      { property: "og:description", content: "Passe no seu concurso com mentoria individual e cursos. Matheus Paiva no seu WhatsApp." },
